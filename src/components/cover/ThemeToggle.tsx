...
export function ThemeToggle() {
  ...
  // Nur der Umschalter. Der Link zum Lebenslauf gehört in die Kopfzeile der
  // Seite – hier stand er ein zweites Mal, als einfacher Anker, der die
  // ganze Seite neu geladen hätte.
  return (
    <>
      <button
        type="button"
