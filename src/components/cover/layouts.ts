...
function defsFor(template: TemplateId, data: CoverData): Def[] {
  ...
  if (template === "sonnig") {
    const f: BlockStyle["font"] = "serif";
    return [
      { id: "eyebrow", label: "Kopfzeile", lines: ["Bewerbungsdossier"], style: s({ x: 20, y: 12, w: 90, size: 8.5, color: "ink", uppercase: true, tracking: 0.4, opacity: 0.6, font: f }) },
      ...
      { id: "kicker", label: "Über-Titel", lines: ["Bewerbung um eine Lehrstelle als"], style: s({ x: 40, y: 108, w: 130, size: 9, color: "bg", align: "center", uppercase: true, tracking: 0.32, opacity: 0.85, font: f }) },
  ...
  if (template === "pastell") {
    const f: BlockStyle["font"] = "serif";
    return [
      { id: "eyebrow", label: "Kopfzeile", lines: ["Bewerbungsdossier"], style: s({ x: 22, y: 22, w: 90, size: 8.5, color: "ink", uppercase: true, tracking: 0.4, opacity: 0.55, font: f }) },
      ...
      { id: "kicker", label: "Über-Titel", lines: ["Bewerbung um eine Lehrstelle als"], style: s({ x: 30, y: 112, w: 150, size: 9, color: "primary", align: "center", uppercase: true, tracking: 0.32, font: f }) },
