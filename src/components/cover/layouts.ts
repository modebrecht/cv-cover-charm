...
function defsFor(template: TemplateId, data: CoverData): Def[] {
    ...
    return [
      {
        id: "eyebrow",
        label: "Kopfzeile",
        lines: [data.eyebrow || "Bewerbungsdossier"],
        style: s({
          x: 20,
          y: 20,
          w: 90,
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 81, y: 55, w: 48, ratio: 1.25, radius: 0, color: "accent", font }),
      },
      {
        id: "kicker",
        label: "Über-Titel",
      ...
      },
      {
        id: "lehrbeginn",
        label: "Lehrbeginn",
        lines: data.lehrbeginn ? [`Lehrbeginn · ${data.lehrbeginn}`] : [],
        style: s({
          x: 20,
          y: 198,
          w: 170,
      ...
      },
      {
        ...
        lines: [...kontakt, ...(data.geburtsdatum ? [`*${data.geburtsdatum}`] : [])],
        style: s({
          x: 20,
          w: 80,
          size: 9,
  ...
  if (template === "edel") {
    ...
    return [
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 84, y: 52, w: 42, ratio: 1, radius: 999, color: "accent", font: f }),
      },
      {
        id: "kicker",
        label: "Über-Titel",
  ...
  if (template === "colorful") {
    ...
    return [
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 128, y: 48, w: 52, ratio: 1, radius: 999, color: "tertiary", font: f }),
      },
      {
        id: "kicker",
        label: "Über-Titel",
      ...
      },
      {
        ...
        label: "Name",
        lines: fullName ? [fullName] : [],
        style: s({ x: 18, y: 172, w: 150, size: 16, color: "primary", weight: 700, font: f }),
      },
      {
        id: "lehrbeginn",
        label: "Lehrbeginn",
  ...
  if (template === "blockig") {
    ...
    return [
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 122, y: 46, w: 60, ratio: 1.2, radius: 0, color: "accent", font: f }),
      },
      {
        id: "kicker",
        label: "Über-Titel",
  ...
  if (template === "edelBlockig") {
    ...
    return [
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 22, y: 48, w: 54, ratio: 1.25, radius: 0, color: "accent", font: f }),
      },
      {
        id: "kicker",
        label: "Über-Titel",
      ...
      },
      {
        ...
        label: "Titel (Beruf)",
        lines: data.beruf ? [data.beruf] : [],
        style: s({ x: 88, y: 68, w: 100, size: 24, color: "ink", lineHeight: 1.15, font: f }),
      },
      {
        id: "name",
        label: "Name",
      ...
      },
      {
        ...
        label: "Lehrbeginn",
        lines: data.lehrbeginn ? [`Lehrbeginn ${data.lehrbeginn}`] : [],
        style: s({ x: 88, y: 114, w: 100, size: 9.5, color: "accent", italic: true, font: f }),
      },
      {
        id: "kontaktTitel",
        label: "Titel Kontakt",
  ...
  if (template === "serioes") {
    ...
    return [
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 82, y: 58, w: 46, ratio: 1.2, radius: 0, color: "primary", font: f }),
      },
      {
        id: "kicker",
        label: "Über-Titel",
    ...
    return [
      {
        id: "eyebrow",
        label: "Kopfzeile",
        lines: [data.eyebrow || "Hallo, schön Sie kennenzulernen"],
        style: s({ x: 20, y: 22, w: 120, size: 10, color: "primary", italic: true, font: f }),
      },
      {
        id: "ortDatum",
        label: "Ort / Datum",
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 20, y: 44, w: 50, ratio: 1, radius: 999, color: "primary", font: f }),
      },
      {
        id: "kicker",
        label: "Über-Titel",
      ...
      },
      {
        ...
        label: "Name",
        lines: fullName ? [fullName] : [],
        style: s({ x: 20, y: 118, w: 170, size: 17, color: "ink", weight: 600, font: f }),
      },
      {
        id: "lehrbeginn",
        label: "Lehrbeginn",
        lines: data.lehrbeginn ? [`Ich freue mich auf den Lehrbeginn ${data.lehrbeginn}`] : [],
        style: s({ x: 20, y: 128, w: 170, size: 10, color: "primary", italic: true, font: f }),
      },
      {
        id: "kontaktTitel",
        label: "Titel Kontakt",
  ...
  if (template === "sonnig") {
    ...
    return [
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 82, y: 46, w: 46, ratio: 1, radius: 999, color: "secondary", font: f }),
      },
      {
        id: "kicker",
        label: "Über-Titel",
  ...
  if (template === "welle") {
    ...
    return [
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 138, y: 62, w: 48, ratio: 1.25, radius: 0, color: "secondary", font: f }),
      },
      {
        id: "kontaktTitel",
        label: "Titel Kontakt",
      ...
      },
      {
        ...
        label: "Kontaktangaben",
        lines: [...kontakt, ...(data.geburtsdatum ? [data.geburtsdatum] : [])],
        style: s({ x: 22, y: 202, w: 60, size: 9, color: "bg", lineHeight: 1.5, font: f }),
      },
      {
        id: "anTitel",
        label: "Titel Empfänger",
    ...
    return [
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 14, y: 24, w: 34, ratio: 1, radius: 999, color: "secondary", font: f }),
      },
      {
        id: "kontaktTitel",
        label: "Titel Kontakt",
      ...
      },
      {
        ...
        label: "Ort / Datum",
        lines: ortDatum ? [ortDatum] : [],
        style: s({ x: 14, y: 268, w: 48, size: 8, color: "bg", opacity: 0.75, font: f }),
      },
      {
        id: "eyebrow",
        label: "Kopfzeile",
  ...
  if (template === "pastell") {
    ...
    return [
      ...
      },
      {
        ...
        kind: "photo",
        lines: [],
        style: s({ x: 82, y: 44, w: 46, ratio: 1.2, radius: 0, color: "primary", font: f }),
      },
      {
        id: "kicker",
        label: "Über-Titel",
  ...
  if (template === "sonne") {
    ...
    return [
      ...
      },
      {
        ...
        label: "Ort / Datum",
        lines: ortDatum ? [ortDatum] : [],
        style: s({ x: 20, y: 26, w: 80, size: 9, color: "ink", opacity: 0.7, font: f }),
      },
      {
        id: "foto",
        label: "Foto",
  ...
  if (template === "verlauf") {
    ...
    return [
      ...
      },
      {
        ...
        label: "Kontaktangaben",
        lines: [...kontakt, ...(data.geburtsdatum ? [data.geburtsdatum] : [])],
        style: s({ x: 22, y: 282, w: 80, size: 9, color: "ink", anchorBottom: true, font: f }),
      },
      {
        id: "anTitel",
        label: "Titel Empfänger",
  ...
  return [
    ...
    // Kreis liegt bewusst auf der Kante des Farbbands – deshalb deckende Füllung.
    {
      ...
      kind: "photo",
      lines: [],
      style: s({ x: 75, y: 82, w: 60, ratio: 1, radius: 999, color: "primary", fill: "bg", font }),
    },
    {
      id: "name",
      label: "Name",
...
export function customDefaultStyle(
  ...
  if (field?.shape) {
    ...
    return s({
      ...
      color: spot.shapeColor,
      fill: outlineOnly ? null : spot.shapeColor,
